...
def main():
    ...
    ingest("SES-201", "warehouse-bot-03", "power", 18, "battery_low", 60, 243712,
           "/battery_state (320 msgs), /cmd_vel (180 msgs), /diagnostics (45 msgs), /odom (600 msgs)")
    ingest("SES-202", "warehouse-bot-07", "power", 15, "battery_low", 60, 251904,
           "/battery_state (318 msgs), /cmd_vel (176 msgs), /diagnostics (44 msgs), /odom (590 msgs)")
    ingest("SES-203", "warehouse-bot-03", "power", 10, "battery_low", 60, 240128,
           "/battery_state (322 msgs), /cmd_vel (181 msgs), /diagnostics (46 msgs), /odom (604 msgs)")
    ingest("SES-204", "warehouse-bot-05", "power", 6, "battery_low", 60, 245760,
           "/battery_state (319 msgs), /cmd_vel (178 msgs), /diagnostics (45 msgs), /odom (598 msgs)")
    ingest("SES-205", "warehouse-bot-07", "power", 2, "battery_low", 60, 250112,
           "/battery_state (321 msgs), /cmd_vel (179 msgs), /diagnostics (45 msgs), /odom (601 msgs)")

    # Cluster B — topic_dropout (perception). 210 resolved; 211 recurs; 212 active.
    ingest("SES-210", "warehouse-bot-05", "perception", 16, "topic_dropout", 60, 512000,
           "/scan (290 msgs), /odom (600 msgs), /tf (1200 msgs), /camera/image_raw (60 msgs)")
    ingest("SES-211", "warehouse-bot-07", "perception", 8, "topic_dropout", 60, 498688,
           "/scan (286 msgs), /odom (598 msgs), /tf (1190 msgs), /camera/image_raw (59 msgs)")
    ingest("SES-212", "warehouse-bot-02", "perception", 3, "topic_dropout", 60, 505856,
           "/scan (288 msgs), /odom (599 msgs), /tf (1195 msgs), /camera/image_raw (60 msgs)")

    # Cluster C — stall (navigation). 220 resolved; 221 recurs; 222 active.
    ingest("SES-220", "warehouse-bot-01", "navigation", 14, "stall", 60, 198656,
           "/cmd_vel (200 msgs), /odom (600 msgs), /scan (290 msgs), /move_base/status (30 msgs)")
    ingest("SES-221", "warehouse-bot-05", "navigation", 5, "stall", 60, 201728,
           "/cmd_vel (198 msgs), /odom (602 msgs), /scan (288 msgs), /move_base/status (31 msgs)")
    ingest("SES-222", "warehouse-bot-01", "navigation", 1, "stall", 60, 199680,
           "/cmd_vel (201 msgs), /odom (601 msgs), /scan (289 msgs), /move_base/status (30 msgs)")

    # Cluster D — path_deviation (navigation).
    ingest("SES-230", "warehouse-bot-02", "navigation", 9, "path_deviation", 60, 187392,
    ...
    resolve("SES-204", "duplicate", dup="SES-201")
    resolve("SES-205", "duplicate", dup="SES-202")
    resolve("SES-210", "resolved",
            "LIDAR USB hub browned out under load; moved the scan driver to a powered hub", "JIRA-4502")
    resolve("SES-211", "duplicate", dup="SES-210")
    ...
    resolve("SES-221", "duplicate", dup="SES-220")
